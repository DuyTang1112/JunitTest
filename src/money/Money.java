...
public class Money implements Comparable {
    ...
    public Boolean equals(Money other) {
        return this.universalValue().compareTo(other.universalValue())==0;
    }
    ...
    public Money add(Money other) {
        return new Money(
                this.amount+currency.valueInThisCurrency(other.amount,other.currency),
                this.currency);
    }
     ...
     */
    public Money negate() {
        return amount<0?new Money(-amount,currency):new Money(amount,currency);
    }
    ...
    public int compareTo(Object other) {
        return sub((Money)other).amount<0? -1: sub((Money)other).amount>0? 1: 0;
    }
}